...
public class PlantWateringService extends IntentService {
    ...
    // done (1): Change ACTION_WATER_PLANT to ACTION_WATER_PLANT and
    ...
    public static final String EXTRA_PLANT_ID = PlantDetailActivity.EXTRA_PLANT_ID;
    ...
    private void handleActionUpdatePlantWidgets() {
        ...
        boolean waterPlantsAllow = false;
        ...
        if (cursor != null && cursor.getCount() > 0) {
            ...
            waterPlantsAllow = (timeNow - wateredAt) > PlantUtils.MIN_AGE_BETWEEN_WATER;

            AppWidgetManager appWidgetManager = AppWidgetManager.getInstance(this);
            int[] appWidgetIds = appWidgetManager.getAppWidgetIds(new ComponentName(this, PlantWidgetProvider.class));
            //Now update all widgets
            PlantWidgetProvider.updatePlantWidgets(this, appWidgetManager, plantID, imgRes, waterPlantsAllow, appWidgetIds);
        }
    }
}
